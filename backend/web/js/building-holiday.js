$(function(){
    ...
    var getSearchResults=function(page){
        ...
        $.ajax({
            type: "POST",
            url: "/building-holiday-status/get-building",
            data: {"buildingName":buildingName,"buildingType":buildingType,"branch":branch,"equipmentType":equipmentType,"page":page,"pageSize":pageSize,"flag":flag},
            dataType: "json",
