...
$this->registerCssFile('/building-record/css/app.45f0db20b3b2525055e50eba1acbeb53.css');
$this->registerJSFile('/building-record/js/manifest.c3d82f5d417d03c66068.js');
$this->registerJSFile('/building-record/js/vendor.201429e74a6eb0dd8878.js');
$this->registerJSFile('/building-record/js/app.2807f08ee8d3417b1055.js');
?>
<div id=app></div>
   ...
   var baseInfo={
    ...
    buildSpecialInfo: {
          ...
          company: {
            ...
            companyNature: ['IT互联网／事务所','其他各类','文化传媒类','贸易零售类'],
            //公司性质
    ...
    var buildingRecordList= <?php echo $buildingRecordList ?>;
    console.log("list",buildingRecordList);
