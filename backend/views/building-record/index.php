...
$this->registerJSFile('http://map.qq.com/api/js?v=2.exp&key=RB5BZ-JSERU-SNBVG-4WPUM-5WWK5-O6FXZ');
$this->registerJSFile('/js/jquery-1.9.1.min.js');
$this->registerCssFile('/js/element-ui/2.4.5/lib/theme-chalk/index.css');
$this->registerCssFile('/building-record/css/app.47c0bf9b4da1f7f9dee7450a8f7a58f5.css');
$this->registerJSFile('/js/vue/2.6.8/vue.js');
$this->registerJSFile('/js/element-ui/2.4.5/lib/index.js');
$this->registerJSFile('/building-record/js/manifest.c3d82f5d417d03c66068.js');
$this->registerJSFile('/building-record/js/vendor.a8741c7cd9eaed59ba0f.js');
$this->registerJSFile('/building-record/js/app.bca7ef19ebdd40b235ab.js');
?>
<div id=app></div>
...
<script type="text/javascript">
   ...
   var baseInfo={
    commonInfo:{
      ...
      coffeeshop:['所在楼下','周边楼下（50m内）','无咖啡厅便利店'],//便利店（现磨）/咖啡厅
    ...
    buildSpecialInfo: {
          ...
          company: {
            equipmentLocation:['人群动线上','距离动线5m以内','距离动线5m以外','隐蔽位置'],
            officeProperty: ['商住 商用率低于90%','商住 商用率高于90%','丙级写字楼','乙级写字楼','甲级写字楼','超甲级写字楼'],//写字楼属性
            hallArea: ['150平米以下','150-300平米','300-500平米','500-1000平米','1000平米以上'],//大堂面积
            lobbyHigh: ['1层','两层及以上'],//大堂挑高
            facadeMaterial: ['普通涂料','面砖／瓷砖／铝板','玻璃幕／大理石'],//外立面材料
    ...
    var buildingRecordList= <?php echo isset($buildingRecordList) ? $buildingRecordList : '{}' ?>;
    var rootErpUrl= '<?php echo Yii::$app->params['erpapi']; ?>';
    var rootCoffeeUrl= '<?php echo Yii::$app->params['fcoffeeUrl']; ?>';
    var rootId= '<?php echo isset($reocrdID) ? $reocrdID : ''; ?>';
</script>
