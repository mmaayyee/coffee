...
<link rel="stylesheet" type="text/css" href="/point-evaluation/css/app.1fa53fa694100ba79e89478e0f0957ee.css">
...
<script type="text/javascript">
   ...
   var baseInfo={
    ...
    buildSpecialInfo: {
          ...
          company: {
            equipmentLocation:['电梯间门口','人群动线上','距离动线5m以内','距离动线5m以外','隐蔽位置'],
            officeProperty: ['商住 商用率低于90%','商住 商用率高于90%','丙级写字楼','乙级写字楼','甲级写字楼','超甲级写字楼'],//写字楼属性
            hallArea: ['150平米以下','150-300平米','300-500平米','500-1000平米','1000平米以上'],//大堂面积
            lobbyHigh: ['1层','两层及以上'],//大堂挑高
            facadeMaterial: ['普通涂料','面砖／瓷砖／铝板','玻璃幕／大理石'],//外立面材料
...
<script type="text/javascript" src="/point-evaluation/js/vendor.2efcb3dde68222512aec.js"></script>
<script type="text/javascript" src="/point-evaluation/js/app.212b87f7879a8f7e13c3.js"></script>
