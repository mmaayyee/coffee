...
<div class="distribution-user-view">
    ...
    <form action="/distribution-user/return-material-record" method="get">
    ...
    <table class="table table-bordered"> 
        ...
        <tbody>
            ...
            <tr> 
                <td><?php echo $recordObj->ctime ? date('Y-m-d H:i:s', $recordObj->ctime) : ''; ?></td>
                ...
                <td><?php echo $recordObj->material_num . $recordObj->material->materialType->unit; ?></td>
