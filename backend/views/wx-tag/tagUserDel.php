...
<div class="wx-tag-create">
    ...
    <div class="wx-tag-form">
        ...
        <?= $form->field($model, 'wx_memberid')->checkboxList(\common\models\WxMember::getMembers($tagid,2)) ?>
        <?= Html::hiddenInput('WxMemberTagAssoc[wx_tagid]',$tagid) ?>
        <div class="form-group">
            <?= Html::submitButton('删除', ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
        </div>
