...
<div>
    <br/>
<p>
    <?php echo !Yii::$app->user->can('批量添加楼宇节假日不运维') ? '' : Html::a('批量添加楼宇节假日不运维', ['/building-holiday-status/add-building-stop'], ['class' => 'btn btn-primary']);?>
    <?php echo !Yii::$app->user->can('批量删除楼宇节假日不运维') ? '' : Html::a('批量删除楼宇节假日不运维', ['/building-holiday-status/remove-building-stop'], ['class' => 'btn btn-primary']);?>
</p>
    <br/>
</div>
