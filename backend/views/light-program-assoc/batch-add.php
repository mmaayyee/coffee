...
$this->params['breadcrumbs'][] = '批量添加设备';
...
$this->registerJsFile("/js/batch-addition.js?v=1.3", ["depends" => [\yii\web\JqueryAsset::className()]]);
...
<div class="block-a">
	...
	<div class="addPreview">
		<h5>添加楼宇预览</h5>
		<form action="/light-program-assoc/batch-add?id=<?php echo $id; ?>" method="post">
