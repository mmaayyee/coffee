...
$this->registerJsFile("@web/js/product_formula.js?v=1.6", ["depends" => [JqueryAsset::className()]]);
...
//$checked = !empty($checkedIngredient[$ingredient['id']]) ? 'checked' : '';
//$sort    = $checkedIngredient[$ingredient['id']] ?? '';
?>
                <!--<li>
                    <input type='checkbox' class="check" name="CoffeeProduct[ingredient][<?php //echo $key;?>][id]" value="<?php //echo $ingredient['id']?>" <?php //echo $checked?>>
                    <label><?php //echo $ingredient['ingredient_name']?></label>
                    <input type='text' class="ingredient-text" name="CoffeeProduct[ingredient][<?php //echo $key?>][sort]" value="<?php //echo $sort?>">
                </li>
            <?php //}?>
