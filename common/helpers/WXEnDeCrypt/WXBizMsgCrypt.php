 ...
 */
namespace common\helpers\WXEnDeCrypt;
use common\helpers\WXEnDeCrypt\sha1;
use common\helpers\WXEnDeCrypt\xmlparse;
use common\helpers\WXEnDeCrypt\pkcs7Encoder;
use common\helpers\WXEnDeCrypt\Prpcrypt;
use common\helpers\WXEnDeCrypt\errorCode;
...
class WXBizMsgCrypt
{
	...
	*/
	public function VerifyURL($sMsgSignature, $sTimeStamp, $sNonce, $sEchoStr, &$sReplyEchoStr)
	{
		...
		$pc = new Prpcrypt();
		$pc->Prpcrypt($this->m_sEncodingAesKey);
