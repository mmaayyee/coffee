 ...
 * 物流接口
 */
class KdApiSearchApi
{
    //请求url
    const REQURL = 'http://testapi.kdniao.cc:8081/api/dist';//'http://api.kdniao.cc:80/Ebusiness/EbusinessOrderHandle.aspx';
    //电商ID
    ...
    public static function getExpressCompany($express = ''){
        $list = [
            'SF' => '顺丰速运',
            'HTKY' => '百世汇通',
            'ZTO' => '中通快递',
