...
!function($) {
   ...
   $.fn.validation.defaults = {
        validRules : [
            ...
            {name: 'number3', validate: function(value) {return (!/^(\s*|0|([1-9]{1}[0-9]{0,4})|([1-9]{1}[0-9]{0,4}\.[0-9]{1,2})|(0\.[0-9]{1,2}))$/.test(value));}, defaultMsg: '请输入正确的范围值(0~99999.99)。'},
            {name: 'number4', validate: function(value) {return (!/^\s*$|^-?[1-9]\d*$/.test(value));}, defaultMsg: '请输入整数。'},
