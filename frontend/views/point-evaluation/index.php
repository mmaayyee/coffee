...
<head>
  ...
  <link href=/point-evaluation/css/app.2c2911d0cf8310e26b0796ca1f1d23d8.css rel=stylesheet>
</head>
<body>
  <div id="app"></div>
  <!-- <script src="http://map.qq.com/api/js?v=2.exp&key=RB5BZ-JSERU-SNBVG-4WPUM-5WWK5-O6FXZ"></script> -->
  <script src="/js/lib/jquery-1.11.1.min.js"></script>
  <script src="https://res.wx.qq.com/open/js/jweixin-1.2.0.js"></script>
  <script>
    var rootData = <?php echo $data; ?>;
    ...
    var baseInfo={
      commonInfo:{
        ...
        rejectReason:['基础信息失实','评分项目错误','照片不规范','照片失实'] //驳回原因
      },
      buildSpecialInfo: {
        officeBuilding: {//写字楼
      ...
      <script type=text/javascript src=/point-evaluation/js/vendor.2efb878914d02168135d.js></script>
      <script type=text/javascript src=/point-evaluation/js/app.bcb7ca662d632e427aed.js></script>
</body>
</html>
