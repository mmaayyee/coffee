...
<body>
      ...
      <div class="order-item">
        <table>
          <tbody>
            ...
            <tr>
              <td>商品数量:</td>
              <td>{{ item.order_cups }}<span class="order-detail-btn" onclick="showOrderNames('{{index}}')">详情&gt;</span></td>
            </tr>
            <!-- <tr>
              <td>订单金额:</td>
            ...
            <tr>
              ...
              <td>{{ item.userAddress }}<span class="location-icon" onclick="showMap('{{index}}')"></span></td>
            </tr>
            <tr>
              <td>下单时间:</td>
  ...
  <script type="text/javascript" src="/delivery/js/not-accept-order.js?v=201812031432"></script>
</body>
</html>
