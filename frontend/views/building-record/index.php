...
<head>
  ...
  <link href=/building-record/css/app.c040db8846d5f09c1948ee0247323449.css rel=stylesheet>
</head>
<body>
  <div id="app"></div>
  <script charset="utf-8" src="https://map.qq.com/api/js?v=2.exp&key=GBWBZ-ILMWK-LMZJU-AJ642-J36CZ-ODBH5"></script>
  <script src="/building-record/js/jquery-2.0.0.min.js"></script>
  <script src="/building-record/js/jquery.cxselect.js"></script>
  ...
  <script>
    ...
    console.log("jsdk",appId,timestamp,nonceStr,signature);
    var rootWxLocationFlag = true;
    var rootErpUrl= '<?php echo Yii::$app->params['frontend']; ?>';
    ...
    var baseInfo={
      ...
      <script type=text/javascript src=/building-record/js/manifest.c3d82f5d417d03c66068.js></script>
      <script type=text/javascript src=/building-record/js/vendor.1aeacdd53e52e6019af9.js></script>
      <script type=text/javascript src=/building-record/js/app.90b00c432b4df171bf98.js></script>
</body>
</html>
